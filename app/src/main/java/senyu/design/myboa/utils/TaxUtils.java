...
import senyu.design.myboa.bean.TaxCost;
...
public class TaxUtils {
     ...
     * 对应的累计金额税率
     */
    public static final float RATE36000 = 3;
    public static final float  RATE144000 = 10;
    public static final float RATE300000 = 20;
    public static final float  RATE420000 = 25;
    public static final float RATE660000 = 30;
    public static final float  RATE960000 = 35;
    public static final float RATE_MAX = 45;

    /**
     * 累计额
     */
    public static final float BASE_THRESHOLD_36000 = 36000;
    public static final float  BASE_THRESHOLD_144000 = 144000;
    public static final float  BASE_THRESHOLD_300000 = 300000;
    public static final float BASE_THRESHOLD_420000 = 420000;
    public static final float BASE_THRESHOLD_660000 = 660000;
    public static final float  BASE_THRESHOLD_960000 = 960000;

    /**
     * 扣除数
     */
    public static final float DEDUCT_VALUE_36000 = 0;
    public static final float DEDUCT_VALUE_144000 = 2520;
    public static final float DEDUCT_VALUE_300000 = 16920;
    public static final float DEDUCT_VALUE_420000 = 31920;
    public static final float DEDUCT_VALUE_660000 = 52920;
    public static final float DEDUCT_VALUE_960000 = 85920;
    public static final float DEDUCT_VALUE_MAX = 181920;
     ...
     * @return
     */
    private static float[] getRateAndDeduct(float money) {
     ...
     * @return
     */
    private static BigDecimal countMoney(int monthIndex, BigDecimal salary, BigDecimal[] lastValue, String... attachMoney) {
        //累计预扣预缴应纳税所得额 =月薪酬*月份
    ...
    public static TaxCost compute(String salary, String... attachMoney) throws InvalidParameterException {
        if (isNull(salary)) {
